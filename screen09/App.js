    ...
    commentsData: [
      {
        ...
        image_user: require('./All_Image/Screen09/Avatar8.png'),
        text: 'Do duis cul 😍',
        time: '17h',
      },
      {
        id: '2',
        username: 'Jason',
        image_user: require('./All_Image/Screen09/Avatar9.png'),
      ...
      },
      {
        ...
        image_user: require('./All_Image/Screen09/Avatar11.png'),
        text: 'Commodo 🔥',
        time: '48m',
      },
    ],
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.inputContainer}>
              <Image source={require('./All_Image/Screen09/Avatar13.png')} />
              <TextInput
